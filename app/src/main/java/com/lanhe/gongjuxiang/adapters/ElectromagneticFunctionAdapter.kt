...
class ElectromagneticFunctionAdapter(
    private val functions: List<ElectromagneticFunction>,
    private val onFunctionClick: (ElectromagneticFunction) -> Unit
) : RecyclerView.Adapter<ElectromagneticFunctionAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_electromagnetic_function, parent, false)
