...
class StorageFunctionAdapter(
    private val functions: List<StorageFunction>,
    private val onFunctionClick: (StorageFunction) -> Unit
) : RecyclerView.Adapter<StorageFunctionAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_storage_function, parent, false)
