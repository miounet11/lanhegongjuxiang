...
class BatteryFunctionAdapter(
    private val functions: List<BatteryFunction>,
    private val onFunctionClick: (BatteryFunction) -> Unit
) : RecyclerView.Adapter<BatteryFunctionAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_battery_function, parent, false)
